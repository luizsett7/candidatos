...
export default {
  ...
  methods: {
    ...
    remover(value, id) {
      ...
      if (this.tecnologias.endsWith(value.name)) {
        this.tecnologias = this.tecnologias.replace(value.name, "");
        if (this.tecnologias.endsWith(",")) {
          this.tecnologias = this.tecnologias.substring(
            0,
            this.tecnologias.length - 1
          );
        }
      } else if (this.tecnologias.endsWith(",")) {
        this.tecnologias = this.tecnologias.replace(value.name + ",", "");
      }
