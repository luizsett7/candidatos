...
<login-template>
    ...
    <span slot="principal">
        ...
        <multiselect @select="toggleSelected" v-model="value" tag-placeholder="Adicionar uma nova tecnologia" placeholder="Buscar uma tecnologia" label="name" track-by="code" :options="options" :multiple="true" :taggable="true" @tag="addTag"></multiselect>
        </div>
