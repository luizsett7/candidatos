...
<home-template>    
    ...
    <b-button size="sm" @click="$router.push('cadastro')" class="mr-1">
          Adicionar
        </b-button> 
  <b-container fluid>    
      ...
      <b-col lg="6" class="my-1">
        ...
        >
          ...
          >
            ...
            <b-form-checkbox value="tecnologias">Tecnologias</b-form-checkbox>
          </b-form-checkbox-group>
        </b-form-group>
      </b-col>
    ...
    >
      ...
      <template #cell(actions)="row">        
        <b-button size="sm" @click="$router.push('alterar/' + row.item.id)" class="mr-1">
          Alterar
        </b-button>  
        <b-button size="sm" @click="$router.push('deletar/' + row.item.id)" class="mr-1">
          Deletar
        </b-button>        
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'linkedin', label: 'Linkedin', sortable: true, class: 'text-center' },
          { key: 'tecnologias', label: 'Tecnologias', sortable: true, class: 'text-center' },
          {
            sortable: false,
